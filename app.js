...
const path = require('path'); // ← Esta es la clave
...
const { v4: uuidv4 } = require('uuid'); // UUID para claves únicas
...
app.get('/', (req, res) => {
  res.redirect('/login.html'); // o /registro-usuario.html si prefieres
  //res.redirect('/registro-usuario.html'); // o /registro-usuario.html si prefieres
});
